...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath="C:\\Users\\Admin\\OneDrive\\Desktop\\LAB IN PSY'\\psychopy\\intentional binding_7\\intentional binding_lastrun.py",
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    trials = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('intentional binding cond.xlsx'), 
        seed=None, 
    )
